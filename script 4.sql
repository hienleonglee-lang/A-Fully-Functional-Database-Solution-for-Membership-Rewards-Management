...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('Testing Status: ' || FN_CHECK_SEASONAL_REDEMPTION(1003, 12, 18.5) || ' to this seasional promotion');
    DBMS_OUTPUT.PUT_LINE('===============================================================');
    DBMS_OUTPUT.PUT_LINE('-');

    DBMS_OUTPUT.PUT_LINE('============ TESTING WITH INSUFFICIENT CUSTOMER POINT =========');
    DBMS_OUTPUT.PUT_LINE('Testing Status: ' || FN_CHECK_SEASONAL_REDEMPTION(1001, 11, 18.5) || ' to this seasional promotion');
    DBMS_OUTPUT.PUT_LINE('===============================================================');
    DBMS_OUTPUT.PUT_LINE('-');

    DBMS_OUTPUT.PUT_LINE('============ TESTING WITH INSUFFICIENT MINIMUN SPEND ==========');
    DBMS_OUTPUT.PUT_LINE('Testing Status: ' || FN_CHECK_SEASONAL_REDEMPTION(1003, 11, 12) || ' to this seasional promotion');
    DBMS_OUTPUT.PUT_LINE('===============================================================');
    DBMS_OUTPUT.PUT_LINE('-');

    DBMS_OUTPUT.PUT_LINE('============ TESTING WITH AN INELIGIBLE TIER ==================');
    DBMS_OUTPUT.PUT_LINE('Testing Status: ' || FN_CHECK_SEASONAL_REDEMPTION(1006, 11, 18.5) || ' to this seasional promotion');
    DBMS_OUTPUT.PUT_LINE('===============================================================');
    DBMS_OUTPUT.PUT_LINE('-');

    DBMS_OUTPUT.PUT_LINE('============ TESTING WITH AN NON-EXISTENT CUSTOMER ============');
    DBMS_OUTPUT.PUT_LINE('Testing Status: ' || FN_CHECK_SEASONAL_REDEMPTION(1010, 11, 18.5) || ' to this seasional promotion');
    DBMS_OUTPUT.PUT_LINE('===============================================================');
    DBMS_OUTPUT.PUT_LINE('-');
END;
/
